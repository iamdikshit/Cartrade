      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="font-display text-xl font-800 text-dark-900">
              Car<span className="text-gradient">Trade</span>
            </span>
          </Link>

          {/* Desktop nav */}
          <div className="hidden lg:flex items-center gap-8">
            <Link href="/cars" className="text-dark-600 hover:text-brand-600 font-medium transition-colors">
              Browse Cars
            </Link>
            <Link href="/cars?status=active" className="text-dark-600 hover:text-brand-600 font-medium transition-colors">
              Available
            </Link>
            <Link href="/#how-it-works" className="text-dark-600 hover:text-brand-600 font-medium transition-colors">
              How It Works
            </Link>
            <Link href="/#contact" className="text-dark-600 hover:text-brand-600 font-medium transition-colors">
              Contact
            </Link>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Link href="/cars" className="flex items-center gap-2 text-dark-600 hover:text-brand-600 font-medium transition-colors px-3 py-2">
